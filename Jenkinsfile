                    ...
                    steps {
                        script {
                            ...
                            dir("liquibase") {
                                ...
                                sh "java -jar liquibase.jar --changeLogFile=${env.changeLog} --classpath=${env.classpath} --driver=${env.driver} --url=${env.URL}  --username=${env.USERNAME} --password=${env.PASSWORD} updateSQL"
                            }
                        }
                    }
                }
